...
# Load the CSV file
df = pd.read_csv(r"C:\Users\krish\OneDrive\Desktop\sem6\llm\project\test_updated_professor_data.csv")
...
df_cleaned.to_csv(r"C:\Users\krish\OneDrive\Desktop\sem6\llm\project\test_updated_professor_data.csv", index=False)
